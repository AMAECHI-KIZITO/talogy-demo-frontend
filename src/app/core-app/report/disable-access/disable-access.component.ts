...
@Component({
  selector: 'app-disable-access',
  templateUrl: './disable-access.component.html',
  styleUrls: ['./disable-access.component.scss']
})
export class DisableAccessComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private dialog: MatDialogRef<DisableAccessComponent>,
  ...
  getUser(){
    this.userList = this.selectedRow.accessList
