export class Util {
  ...
  public static months = [
    {name:'January', last:'31', id: 1, month:'01', abbr: 'Jan' },
    {name:'Febuary', last:'28', id: 2, month:'02', abbr: 'Feb'},
    {name:'March', last:'31', id: 3, month:'03', abbr: 'Mar'},
    {name:'April', last:'30', id: 4, month:'04', abbr: 'Apr'},
    {name:'May', last:'31', id: 5, month:'05', abbr: 'May'},
    {name:'June', last:'30', id: 6, month:'06', abbr: 'Jun'},
    {name:'July', last:'31', id: 7, month:'07', abbr: 'Jul'},
    {name:'August', last:'31', id: 8, month:'08', abbr: 'Aug'},
    {name:'September', last:'30', id: 9, month:'09', abbr: 'Sep'},
    {name:'October', last:'31', id: 10, month:'10', abbr: 'Oct'},
    {name:'November', last:'30', id: 11, month:'11', abbr: 'Nov'},
    {name:'December', last:'31', id: 12, month:'12', abbr: 'Dec'}
  ]
